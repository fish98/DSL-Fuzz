...
bison libglib2.0-dev libpixman-1-dev python3-setuptools cargo libgtk-3-dev python3-pip apt-utils

# For AFL++
RUN apt-get install -y lld-14 llvm-14 llvm-14-dev \
clang-14 || apt-get install -y lld llvm llvm-dev clang
